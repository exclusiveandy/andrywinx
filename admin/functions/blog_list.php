...
echo '  <table id="blog_table_id" class="table">
			<thead>
			<tr>
				<th style="border: none !important;">Title</th>
				<th style="border: none !important;">Date Created</th>
			</tr>
		</thead>';
		...
		echo "<tr>
				...
				<td class='text-right py-0 align-middle'>
					<div class='btn-group btn-group-sm'>
						<a href='blog_view?id=".$user_id."&blog_id=".$row['blog_id']."'' class='btn btn-info'><i class='fas fa-eye'></i></a>
