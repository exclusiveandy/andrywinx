...
<head>
  ...
  <title>Inquire - Lumikha at Maglaro</title>
...
<div class="content-wrapper">
	...
	<div class="content">
		<div class="container">
			...
			<h3 class="text-center">Ano pong kailangan nyo?</h3>
			<br>

			<div class="row">
				<div class="col-md-4">
					<div class="card rounded">
					  <img src="images/1.png" class="card-img-top rounded-top" alt="...">
					  <div class="card-body">
					    <h4>Kailangan mo ba ng Developer?</h4>
				...
				<div class="col-md-4">
					<div class="card">
					  <img src="images/1.png" class="card-img-top rounded-top" alt="...">
					  <div class="card-body">
					    <h4>Kailangan mo ba ng taga Edit?</h4>
					    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					    <a href="#" class="btn btn-primary">Go somewhere</a>
					  </div>
					</div>
				...
				<div class="col-md-4">
					<div class="card">
					  <img src="images/1.png" class="card-img-top rounded-top" alt="...">
					  <div class="card-body">
					    <h4>Kailaban mo ba ng Musikero?</h4>
					    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
					    <a href="#" class="btn btn-primary">Go somewhere</a>
					  </div>
					</div>
			...
			<br>
			<h3 class="text-center">Ekslusibong Exposey</h3>
			<br>
